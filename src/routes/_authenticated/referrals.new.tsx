...
function NewReferralPage() {
  ...
  return (
    <ClinicalAccessGate>
    <div className="p-4 sm:p-6 max-w-3xl lg:max-w-5xl mx-auto">
      ...
      <form onSubmit={submit} className="space-y-6">
        <Section title="Patient">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Field label="Patient initials"><Input value={f.patient_initials} maxLength={40} placeholder="e.g. JS" onChange={(e) => set("patient_initials", e.target.value)} onBlur={(e) => set("patient_initials", toInitials(e.target.value))} /></Field>
